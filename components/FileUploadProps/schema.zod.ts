...
in the text area from opening file dialog. */
  ...
  onFileInputChange: z.custom<Event>().optional(),
  /** A callback for when the FileReader API fails. */
  onReadFailed: z.custom<Event>().optional(),
  /** A callback for when a selected file finishes loading. */
  onReadFinished: z.custom<Event>().optional(),
  /** A callback for when a selected file starts loading. */
  onReadStarted: z.custom<Event>().optional(),
...
export type FileUploadPropsProps = z.infer<typeof FileUploadPropsSchema>
