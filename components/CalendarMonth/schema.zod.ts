...
export const CalendarMonthSchema = z.object({
  ...
  dayFormat: z.any().optional().default('(date) => date.getDate()'),
...
See https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl#Locale_identification_and_negotiation */
  ...
  longWeekdayFormat: z.any().optional().default('(date) => date.toLocaleDateString(locale, { weekday: 'long' })'),
  /** How to format months in month select. */
  monthFormat: z.any().optional().default('(date) => date.toLocaleDateString(locale, { month: 'long' })'),
  ...
  validators: z.array(z.any()).optional().default('[() => true]'),
  /** How to format week days in header. */
  weekdayFormat: z.any().optional().default('(date) => date.toLocaleDateString(locale, { weekday: 'narrow' })'),
